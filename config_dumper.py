...
if SAMPLE=='TCC':
    ...
    PATH_signal='/eos/user/m/mcentonz/CxAODReader_output/out_ZV2Lep_TCC_EMTopo_SIGNAL/fetch/data-MVATree/'
    PATH_bkg='/eos/user/m/mcentonz/CxAODReader_output/out_ZV2Lep_TCC_EMTopo_BKG/fetch/data-MVATree/'
...
INPUT_PATH='/eos/user/m/mcentonz/CxAODReader_output/INPUT/'
